...
4) Reprendre le code original de l'affichage d'un graphe et le mettre dans le fichier graph.js (alléger le fichier html)

5) Afficher les trois courbes demandés (f, f', f'')